    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                status = table.Column<short>(type: "smallint", nullable: false, comment: "Status"),
                metadata = table.Column<string>(type: "jsonb", nullable: true, defaultValueSql: "'{}'::jsonb", comment: "Metadata"),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                status = table.Column<short>(type: "smallint", nullable: true, comment: "Status"),
                created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: true, comment: "Created"),
                updated_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: true, comment: "Updated")
            },
            constraints: table =>
